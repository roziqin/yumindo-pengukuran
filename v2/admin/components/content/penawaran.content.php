            ...
            $('#table-penawaran').DataTable({
                ...
                "columns": [
                    ...
                    { "width": "150px", "render": function(data, type, full){
                       return '<a class="btn-floating btn-sm btn-default mr-2 btn-edit" href="?menu=transaksi&kond=detail&id='+full['pengukuran_id']+'" data-id="' + full['pengukuran_id'] + '" title="Detail"><i class="fas fa-pen"></i></a>';
                        }
                    },
                ],
                "drawCallback": function( settings ) {
                    $('.btn-edit').on('click',function(e){
                        e.preventDefault();
                        var id = $(this).data('id');
                        $('.container__load').load('components/content/penawaran.content.php?kond=detail&id='+id, function() {
                            $("#form-pelanggan #defaultForm-idpenawaran").val(id); 
                        });
        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <form id="form-pelanggan">
                    <input type="hidden" name="ip-idpenawaran" id="defaultForm-idpenawaran" class="id-form">

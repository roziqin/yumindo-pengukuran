					...
					while ($datatea=mysql_fetch_array($queryte1)) {
						...
						?>
			                <div class="col-md-3 col-md-offset-0 with-border barang">
			                	<a href="?menu=model&idukur=<?php echo $_GET['idukur']; ?>&id=<?php echo $datatea["jenis_id"]; ?>"><?php echo $datatea["jenis_nama"]; ?></a>
			                </div>
						<?php
						} else {
							# code...
						?>
			                <div class="col-md-3 col-md-offset-0 with-border barang">
			                	<a href="?menu=bahan&&idukur=<?php echo $_GET['idukur']; ?>id=<?php echo $datatea["jenis_id"]; ?>&model=0"><?php echo $datatea["jenis_nama"]; ?></a>
			                </div>
						<?php
						}
					...
					if ($datatea["model_id"]==0) {
						...
						if ($data['jenis_nama']=='Poni Polos'||$data['jenis_nama']=='Poni Motif') {
							...
							if ($datatea['model_nama']=='Triplet') {
								...
								?>
					                <div class="col-md-3 col-md-offset-0 with-border barang">
					                	<a href="?menu=lain&idukur=<?php echo $_GET['idukur']; ?>&id=<?php echo $_GET["id"]; ?>&model=<?php echo $datatea["model_id"]; ?>"><?php echo $datatea["model_nama"]; ?></a>
					                </div>
								<?php
							} 
						} else {
							if ($datatea['model_nama']=='Papan'||$datatea['model_nama']=='Drappery') {
								...
								?>
					                <div class="col-md-3 col-md-offset-0 with-border barang">
					                	<a href="?menu=bahan&idukur=<?php echo $_GET['idukur']; ?>&id=<?php echo $_GET["id"]; ?>&model=<?php echo $datatea["model_id"]; ?>"><?php echo $datatea["model_nama"]; ?></a>
					                </div>
								<?php
							}
	...
	?>
		<div class="box box-success">
            ...
            <div class="box-body">
				...
				?>
	                <div class="col-md-3 col-md-offset-0 with-border barang">
	                	<a href="?menu=lain&idukur=<?php echo $_GET['idukur']; ?>&id=<?php echo $_GET["id"]; ?>&model=<?php echo $_GET["model"]; ?>&bahan=<?php echo $datatea["kain_id"]; ?>"><?php echo $datatea["kain_nama"]; ?></a>
	                </div>
				<?php
		...
		<div class="box box-success">
            ...
            <div class="box-body">
                ...
                <form action="aksi/transaksi.aksi.php" method="post">
					    <input type="hidden" name="idukur" class="form-control" id="" value="<?php echo $_GET['idukur'];?>">
					...
					?>
						<input type="hidden" name="kodebahan1" class="form-control" id="kodebahan1" value="">
					...
					?>
						<input type="hidden" name="hargabahan" class="form-control" id="hargabahan" value="">
					<?php
					} else {
					?>
					...
					<div class="form-group">
					    <input type="submit" class="btn btn-success pull-right btn-lg" value="Input" name="tambahpengukuran" style="font-size: 14px;">
					</div>
				</form>
